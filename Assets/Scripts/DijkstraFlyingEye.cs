...
public class DijkstraFlyEye : MonoBehaviour
{
    ...
    void Start()
    {
        if (Player != null)
        {
            ...
            dijkstraPath = GetComponent<Dijkstra>();
    ...
    public void ReCalculatePath()
    {
        ...
        PathToTarget = dijkstraPath.GetPath(Player.transform.position);
        ...
        if (PathToTarget.Count == -1)
        {
            ...
            if (!SeeTarget)
            {
                var r = UnityEngine.Random.Range(0, dijkstraPath.FreeNodes.Count);
                RandomPath = dijkstraPath.GetPath(dijkstraPath.FreeNodes[r].PositionDijkstra);
